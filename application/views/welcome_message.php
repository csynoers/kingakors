...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="<?= base_url('assets/amado/img/core-img/favicon.ico')?>">
...
<body>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="index.html"><img src="<?= base_url('assets/amado/img/core-img/logo2.png')?>" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
                        <p class="copywrite">
    ...
    <!-- Bootstrap js -->
    <script src="<?= base_url('assets/amado/js/bootstrap.min.js')?>"></script>
    <!-- Plugins js -->
